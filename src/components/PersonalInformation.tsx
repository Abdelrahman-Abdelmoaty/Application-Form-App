...
import { Question, setPersonalInformationQuestions } from "../App/DataSlice";
import useDidMountEffect from "../hooks/useDidMountHook";

export default function PersonalInformation() {
  const dispatch = useAppDispatch();
  const data: Question[] = useAppSelector((state) => state.data.data.personalInformation.personalQuestions);
